  ...
  return (
    <form noValidate onSubmit={onSubmit} className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        {errors.password ? <p className="px-1 text-xs font-bold text-coral">{errors.password}</p> : null}
      </div>
      ...
      <div className="flex items-center gap-2.5">
        ...
        />
        <label htmlFor="remember" className="text-xs font-bold text-ink/55 cursor-pointer select-none">
          Remember me for 30 days
        </label>
      </div>

      <Button type="submit" variant="primary" size="lg" className="w-full h-12 rounded-xl" disabled={loading}>
