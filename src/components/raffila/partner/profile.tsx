  ...
  const docs: DocItem[] = [
    {
      ...
      required: true,
      uploaded: true,
      fileName: "CAC-RC1872456-cert.pdf",
      verified: true,
      updatedAt: "2026-03-14",
    },
    {
      id: "cac2",
      label: "CAC Forms (CAC2/CAC7)",
      required: true,
      uploaded: true,
      fileName: "CAC-forms-bundle.pdf",
      verified: true,
      updatedAt: "2026-03-14",
    },
    {
      id: "tax",
      label: "Tax Identification (TIN/JTB)",
      required: true,
      uploaded: true,
      fileName: "FIRS-TIN-24187642.pdf",
      verified: true,
      updatedAt: "2026-03-14",
    },
    {
      id: "id",
      label: "Director Valid ID (PVC/NIN/Passport)",
      required: true,
      uploaded: true,
      fileName: "Adaeze-Okafor-NIN-front-back.pdf",
      verified: true,
      updatedAt: "2026-03-14",
    },
    {
      id: "address",
      label: "Proof of Address (Utility / Lease)",
      required: true,
      uploaded: true,
      fileName: "Ikeja-Electric-bill-Mar-2026.pdf",
      verified: true,
    ...
    },
    {
      ...
      required: true,
      uploaded: true,
      fileName: "Zenith-acct-conf-2026.pdf",
      verified: true,
    ...
    },
    {
      ...
      required: false,
      uploaded: true,
      fileName: "Trade-Ref-Innoson-Motors.pdf",
      verified: true,
      updatedAt: "2026-03-20",
    },
    { id: "refs2", label: "Trade Reference 2", required: false, uploaded: false, verified: false },
    {
      ...
      required: false,
      uploaded: true,
      fileName: "LLA-catalogue-2026-Q3.pdf",
      verified: false,
            ...
            <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-6 items-center">
              ...
              <div className="min-w-0 space-y-1.5">
                <div className="flex items-center gap-2 flex-wrap">
                  <h2 className="font-display text-2xl sm:text-3xl text-cream truncate">
                    {orgName}
                  </h2>
                ...
                <div className="flex items-center gap-4 flex-wrap text-sm text-cream/70 font-body">
                  <span className="flex items-center gap-1.5">
                    <Building2 className="w-4 h-4" /> {rcNumber} · {bizType}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <MapPin className="w-4 h-4" /> {city}, {state}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Calendar className="w-4 h-4" /> Partner since Mar 2026
                  </span>
                </div>
                <div className="flex items-center gap-5 pt-2 flex-wrap">
                  {[
                    ...
                    <div key={m.k}>
                      <p className="text-[10px] uppercase tracking-wider text-cream/50 font-body">
                        {m.k}
                      </p>
              ...
              <div className="md:max-w-xs w-full md:w-auto bg-cream/5 border border-cream/15 rounded-2xl p-4 space-y-3 backdrop-blur">
                <div>
                  ...
                  <div className="h-2.5 bg-cream/10 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-mint via-coral to-lemon rounded-full transition-all"
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-body">
                  <div className="p-2 rounded-xl bg-cream/5">
                    ...
                    <p className="font-display font-bold text-cream text-base">
                ...
                {requiredDone === requiredTotal ? (
                  ...
                  <p className="text-[11px] text-lemon font-semibold flex items-center gap-1 font-body">
                    <Clock className="w-3.5 h-3.5" /> {requiredTotal - requiredDone} required
                    pending
                  </p>
                )}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
          <div className="lg:col-span-3 space-y-5">
            <Card className="border-ink/10">
              <CardHeader className="pb-3 flex-row items-start justify-between space-y-0 flex-wrap gap-3">
                <div className="flex items-center gap-2">
                  <div className="p-2.5 rounded-2xl bg-sky/20 text-sky border border-sky/30">
                    <Building2 className="w-5 h-5" />
                  </div>
                  <div>
                    <CardTitle className="font-display text-ink text-lg">
              ...
              <CardContent className="pt-0 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select value={employees} onValueChange={setEmployees}>
                    ...
                    <SelectContent>
                      {["1-9", "10-49", "50-99", "100-249", "250+"].map((x) => (
                        <SelectItem key={x} value={x}>
                          {x}
                        </SelectItem>
                      ))}
            ...
            <Card className="border-ink/10">
              <CardHeader className="pb-3 flex-row items-start justify-between space-y-0 flex-wrap gap-3">
                <div className="flex items-center gap-2">
                  <div className="p-2.5 rounded-2xl bg-mint/30 text-ink border border-mint/40">
                  ...
                  <div>
                    ...
                    <CardDescription className="font-body text-sm">
                      Used for verification & correspondence
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="pt-0 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2 space-y-1.5">
                  ...
                  <Input
                    className="rounded-xl font-mono w-full sm:w-56"
                    value={postal}
            ...
            <Card className="border-ink/10">
              <CardHeader className="pb-3 flex-row items-start justify-between space-y-0 flex-wrap gap-3">
                <div className="flex items-center gap-2">
                  <div className="p-2.5 rounded-2xl bg-coral/20 text-coral border border-coral/30">
                  ...
                  <div>
                    ...
                    <CardDescription className="font-body text-sm">
                      Raffila account owner & primary settlement authoriser
                    </CardDescription>
                  </div>
                </div>
                <Button
              ...
              <CardContent className="pt-0 grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Select value={cpTitle} onValueChange={setCpTitle}>
                    ...
                    <SelectContent>
                      {["Mr.", "Mrs.", "Miss", "Ms.", "Dr.", "Chief", "Alh.", "Engr."].map((t) => (
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    className="rounded-xl"
                    value={cpFirst}
                    onChange={(e) => setCpFirst(e.target.value)}
                  />
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs uppercase tracking-wider text-ink/60 font-body">
                  ...
                  <Input
                    className="rounded-xl"
                    value={cpLast}
                    onChange={(e) => setCpLast(e.target.value)}
                  />
                </div>
                <div className="sm:col-span-2 space-y-1.5">
                  <Label className="text-xs uppercase tracking-wider text-ink/60 font-body">
                ...
                <div className="space-y-1.5">
                  <Label className="text-xs uppercase tracking-wider text-ink/60 font-body flex items-center gap-1">
          ...
          <div className="lg:col-span-2 space-y-5">
              ...
              <CardHeader className="pb-3 flex-row items-start justify-between space-y-0 flex-wrap gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription className="font-body text-sm">
                      All payouts go here · verified by bank letter
                    </CardDescription>
                  </div>
                </div>
                <Button
              ...
              <CardContent className="pt-0 space-y-4">
                <div className="p-3 rounded-xl bg-mint/10 border border-mint/30 flex items-center gap-2">
                  ...
                  <p className="text-xs text-ink/80 font-body">
                    <span className="font-bold">Verified.</span> Bank letter on file confirms
                    account name matches RC {rcNumber}.
                  </p>
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs uppercase tracking-wider text-ink/60 font-body">
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-ink/60 font-body mb-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 rounded-xl bg-cream/50">
                      <div>
                        ...
                        <p className="text-[11px] text-ink/50 font-body">
                          Weekly disbursement date
                        </p>
                      </div>
                      <Select value={settlementDay} onValueChange={setSettlementDay}>
                        <SelectTrigger className="rounded-full w-36 h-9">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-xl bg-cream/50">
                      ...
                      <div className="relative w-40">
                        ...
                        <Input
                          className="rounded-full pl-7 pr-3 text-right font-display font-semibold h-9"
                          value={minSettle}
                          onChange={(e) => setMinSettle(e.target.value.replace(/[^\d]/g, ""))}
                        />
                      </div>
                    </div>
                  </div>
            ...
            <Card className="border-ink/10">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-2">
                  <div className="p-2.5 rounded-2xl bg-lilac/20 text-lilac border border-lilac/30">
                ...
                {[
                  {
                    ...
                    s: setNotifyEmail,
                    l: "Email alerts",
                    d: "Settlement, listing, approvals",
                  ...
                  },
                  {
                    ...
                    s: setNotifySms,
                    l: "SMS text alerts",
                    d: "Time-sensitive draw & payout events",
                    i: <Phone className="w-4 h-4" />,
                  },
                  {
                    id: "nw",
                    k: notifyWhatsapp,
                    s: setNotifyWhatsapp,
                    l: "WhatsApp alerts",
                    d: "Weekly summary + instant draws",
                  ...
                  },
                  {
                    ...
                    k: marketing,
                    s: setMarketing,
                    l: "Marketing & opportunities",
                    d: "Exclusive partner promos & campaigns",
                    i: <Star className="w-4 h-4" />,
                  },
                ].map((n) => (
                  <div
                    key={n.id}
                    className="flex items-center justify-between gap-3 p-3 rounded-xl bg-cream/40 border border-ink/5 hover:border-coral/30 transition"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div
                        className={`p-2 rounded-lg ${n.k ? "bg-coral/20 text-coral" : "bg-ink/5 text-ink/40"}`}
                      >
                        {n.i}
                      </div>
            ...
            <Card className="border-ink/10">
              <CardHeader className="pb-3 flex-row items-start justify-between space-y-0 flex-wrap gap-3">
                <div className="flex items-center gap-2">
                  <div className="p-2.5 rounded-2xl bg-lemon/30 text-ink border border-lemon/40">
              ...
              <CardContent className="pt-0 space-y-2">
                {docs.map((d) => (
                  <div
                    key={d.id}
                    className="p-3 rounded-xl border border-ink/10 hover:border-ink/20 transition flex items-start gap-3 group"
                  >
                    <div
                    ...
                    >
                      {d.verified ? (
                        ...
                        <Clock className="w-4 h-4 text-lemon" />
                      ) : (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {d.required ? (
                          <Badge className="rounded-full bg-coral/15 text-coral border-coral/30 text-[9px] font-bold">
                            REQUIRED
                          </Badge>
                        ) : (
                          <Badge
                            variant="outline"
                            className="rounded-full text-[9px] bg-ink/5 text-ink/60 border-ink/15"
                          >
                            OPTIONAL
                          </Badge>
                        )}
                      ...
                      {d.uploaded ? (
                        <>
                          <Button
                            variant="ghost"
                            size="icon"
                            className="rounded-full h-8 w-8 text-ink/50 hover:text-coral"
                          >
                        ...
                        <Button
                          ...
                          onClick={() => toast.success(`Upload dialog: ${d.label}`)}
                        >
