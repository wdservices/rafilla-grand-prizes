          ...
          >
            {step === 1 && (
              <div className="space-y-5 pt-2">
                ...
                <div className="rounded-2xl bg-paper p-4 ring-1 ring-ink/5">
                  <div className="flex items-center justify-between text-xs font-extrabold uppercase tracking-widest text-ink/45">
                    ...
                    <span className="text-ink/70">
                      {competition.entriesSold.toLocaleString()} /{" "}
                ...
                {showOversell && <OversellBanner remaining={remaining} />}
              ...
              <div className="space-y-5 pt-2 pb-4 text-center">
                ...
                <div className="flex items-center justify-center gap-2 pt-1">
                  <Button
                    ...
                    size="md"
                    onClick={() => {
                      const text = `I just entered to win ${competition.title} on Rafilla! ${qty} tickets secured. 🎟️`;
                  ...
                  <Button
                    ...
                    size="md"
                    onClick={() => {
                      const text = `I just entered to win ${competition.title} on Rafilla!`;
                      window.open(
