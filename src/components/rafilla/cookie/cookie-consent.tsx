...
const COOKIE_KEY = "rafilla.cookieConsent.v1";
const EVENT_OPEN = "rafilla:cookie-open";
              ...
              <div className="flex flex-1 items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-ink/65">
                    We use cookies to keep Rafilla secure, understand usage, and improve. We never
            ...
            <div className="rounded-[22px] bg-paper p-5 ring-1 ring-ink/5">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-ink/60">
                    Aggregate usage data to improve Rafilla. Covers Google Analytics / Plausible
