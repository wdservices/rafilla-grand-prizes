...
import { competitions, getCompetition, winnerCards } from "@/lib/rafilla-data";
...
function makeDrawRecord(slug: string, forceStatus?: DrawStatus): DrawRecord {
  ...
  return {
    ...
    algorithmSalt: "rafilla-draw-v1::" + (competition?.slug ?? slug) + "::t-5-snapshot",
...
export function DrawVerificationPage({ campaignId }: { campaignId?: string }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Rafilla uses an external public randomness beacon (Beacon Chain Beacon Network). The seed is determined after the snapshot is committed, so it cannot be known in advance or influenced by anyone at Rafilla.",
    },
    {
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 lg:py-14">
      ...
      <section className="mt-10">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-3">
          ...
          <HowStepCard
            ...
            text="An external public randomness beacon emits a seed AFTER the snapshot. This seed is unknowable to Rafilla and independent of our systems."
          />
          <HowStepCard
            step="3"
      ...
      <section className="mt-10 grid gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-[22px] bg-paper p-5 ring-1 ring-ink/5 sm:p-6">
          ...
          <p className="mt-4 text-xs font-bold leading-relaxed text-ink/60">
            This seed is{" "}
            <span className="font-extrabold text-ink">unknowable to Rafilla</span> and determined
            after the snapshot. Rafilla cannot predict or bias the seed.
          </p>
        </div>
        ...
        <div className="rounded-[22px] bg-paper p-5 ring-1 ring-ink/5 sm:p-6">
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              copyText("https://github.com/rafilla/verification-script", "Source link copied");
            }}
