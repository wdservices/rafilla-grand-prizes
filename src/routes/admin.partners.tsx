...
import { AdminPartnersPage } from "@/components/raffila/admin";
...
export const Route = createFileRoute("/admin/partners")({
  head: () => {
    ...
    const title = "Partners — Admin · Raffila";
    const description =
      "Private admin partners module: onboard new prize partners, approve KYC, review submitted assets, track partner revenue, and manage listings. Noindex staff-only. raffila.com";
    return {
      meta: [
        { title },
