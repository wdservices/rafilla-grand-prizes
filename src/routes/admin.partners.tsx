...
import { AdminPartnersPage } from "@/components/rafilla/admin";
...
export const Route = createFileRoute("/admin/partners")({
  head: () => {
    ...
    const title = "Partners — Admin · Rafilla";
    const description =
      "Private admin partners module: onboard new prize partners, approve KYC, review submitted assets, track partner revenue, and manage listings. Noindex staff-only. rafilla.com";
    return {
      meta: [
        { title },
