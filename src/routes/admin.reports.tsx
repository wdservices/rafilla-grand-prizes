...
import { AdminReportsPage } from "@/components/rafilla/admin";
...
export const Route = createFileRoute("/admin/reports")({
  head: () => {
    ...
    const title = "Reports — Admin · Rafilla";
    const description =
      "Private admin reports: revenue analytics, users growth, competitions performance, winner payouts, referral commissions and CSV/PDF exports. Noindex. rafilla.com";
    return {
      meta: [
        { title },
