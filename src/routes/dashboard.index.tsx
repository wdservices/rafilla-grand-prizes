...
export const Route = createFileRoute("/dashboard/")({
  head: () => {
    ...
    const title = "Dashboard — Rafilla";
    const description =
      "Private dashboard: wallet balance, competition entries, referrals progress, prize notifications and account overview. Noindex user area. rafilla.com";
    return {
      meta: [
        { title },
