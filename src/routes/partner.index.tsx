...
import { PartnerOverviewPage } from "@/components/rafilla/partner";
...
export const Route = createFileRoute("/partner/")({
  head: () => {
    ...
    const title = "Partner portal — Rafilla";
    const description =
      "Private partner portal overview: listings, revenue analytics, settlements, asset submissions and KYC controls for registered Rafilla prize partners. rafilla.com";
    return {
      meta: [
        { title },
