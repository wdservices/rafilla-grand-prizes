...
import { PartnerOverviewPage } from "@/components/raffila/partner";
...
export const Route = createFileRoute("/partner/")({
  head: () => {
    ...
    const title = "Partner portal — Raffila";
    const description =
      "Private partner portal overview: listings, revenue analytics, settlements, asset submissions and KYC controls for registered Raffila prize partners. raffila.com";
    return {
      meta: [
        { title },
