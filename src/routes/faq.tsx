...
import { faqs } from "@/lib/rafilla-data";
...
export const Route = createFileRoute("/faq")({
  head: () => {
    ...
    const title = "FAQ — Questions about entries, wallet, draws, referrals · Rafilla";
    const description =
      "Frequently asked questions: How to enter Rafilla competitions, wallet rules, referral commissions, draw verification, claiming prizes, refunds and more. rafilla.com";
