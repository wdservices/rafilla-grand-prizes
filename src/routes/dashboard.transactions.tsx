...
export const Route = createFileRoute("/dashboard/transactions")({
  head: () => {
    ...
    const title = "My transactions — Rafilla";
    const description =
      "Private full audit trail: wallet top ups, competition entry deductions, referral commissions, referral payouts, refunds and all account transactions. Noindex. rafilla.com";
    return {
      meta: [
        { title },
